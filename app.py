...
st.markdown("안녕하세요... 영업가족분들이 자주 묻는 질문과 그에 대한 답변을 입력해주시면 영업가족분들이 모바일을 통해 여기에 있는 답변을 조회할 수 있습니다. 하루에 한가지씩만 입력해주셔도 되여~~ 우리 충청호남본부 임직원여러분을 항상 응원합니다!!! 최근 등록한 질문들은 하단에서 볼 수 있습니다. 질문과 답변은 충호본부 매니저 봇인 애순이봇을 이용하시면 됩니다.")
